...
const Addcase = ({ walletUpdate }) => {
  ...
  const decentroDepositeUpi = (channel, method, upiMethod, decentropay) => {
    ...
    axios
      .get("https://morniinc.in/payment.php?amount=" + global, {
  ...
  const phonePeDepositeUpi = (channel, method, upiMethod, phonepay) => {
    ...
    axios
      .post(
        baseUrl+"phonepev1/accept?amount=" +
          global +
          "&id=" +
          access_token,
        {
      ...
      .then((res) => {
        ...
        if (res.data.success === true) {
          ...
          let order_token = res.data.data.txnID;
          //setProcess(false);
          window.location.assign(res.data.data.instrumentResponse.redirectInfo.url);
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setPhonePeActive(res.data.PhoneStatus);
          ...
          {Boolean(!process) && (
            <div>
              ...
              <label htmlFor="username " className="mr-5">
               ...
               बैंक सर्वर डाउन होने की वजह से कुछ समय के लिए के लिए डायरेक्ट पेमेंट को रोका गया है अभी थोड़ी देर मैं फिर से स्टार्ट हो जायेगा तब तक आप बार कोड से पेमेंट कर सकते है
                  </div>
...
<br />
                    ...
                    {global>=2000 &&global<=25000&& Boolean(isPhonePeActive) && (
                      <div
                        onClick={() => {
                          method.current = "upipay";
                          phonePeDepositeUpi(
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="d-flex justify-content-center flex-column ml-4">
                            <div className="jss30">
                              <strong>Pay Now via PhonePe</strong>
                            </div>
                            <div className="jss31"></div>
                          </div>
                        </div>
...
<div class="alert alert-primary text-dark text-center text-bold" role="alert">
  प्लेयर्स कृपया ध्यान दे जब आपका पेमेंट आपके अकाउंट से कट हो जाये उसके बाद वेबसाइट पे जब तक आपको OK लिखा हुवा मेसेज ना आये तब तक आपको बैक नहीं होना है
</div>
