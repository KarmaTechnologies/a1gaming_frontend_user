...
const Withdrawopt = ({ walletUpdate }) => {
  ...
  const [payoutFlagsLoaded, setPayoutFlagsLoaded] = useState(false);
  const [submitBtn, setSubmitBtn] = useState(true);
  const [mypayzoneSelectedType, setMypayzoneSelectedType] = useState("");
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setMypayzoneSelectedType(res?.data?.mypayzone2Select || "")

        setPayoutFlagsLoaded(true);
        console.log(res, "fejfeefjfej")
  ...
  const updateBankDetails = async () => {
    ...
    // e.preventDefault();
    let confirm = false;
    if (type == "upi" || type == "manualupi" || type == "mypayupi" || mypayzoneSelectedType === "UPI") {
    ...
    let isBT = false;
    let isUPIT = false;
    if (type == "upi" || type == "manualupi" || type == "mypayupi" || (type === "mypayzone" && mypayzoneSelectedType === "UPI")) {
      isUPIT = true;
      isBT = false;
    } else {
      isBT = true;
    ...
    let mypayzoneUpi = false;
    if (type === "mypayzone" && mypayzoneSelectedType === "UPI") {
      mypayzoneUpi = true;
    }
      ...
      const data = await axios
        .patch(
          baseUrl + `user/edit`,
          {
            ...
            bankDetails: isBT,
            upiDetails: isUPIT,
            mypayzoneUpi: type === "mypayzone" && mypayzoneSelectedType === "UPI",
          },
          { headers }
        )
        .then((res) => {
  ...
  console.log("rnncjrcncicnc", mypayzoneSelectedType)
      ...
      await axios
        .post(
          baseUrl + `withdraw/request`,
          {
            ...
            type,
            payment_gatway,
            accountType: mypayzoneSelectedType,
          },
          { headers }
        )
        .then((res) => {
    ...
    <>
      ...
      >
        ...
        {!payoutFlagsLoaded ? (
          ...
          (isMypayPayoutActive === false &&

            isManualPayoutActive === false &&

            isMypayPayoutBankActive === false &&

            isMypayzonePayoutBankActive === false &&

            isMypayzone2PayoutBankActive === false &&
            ...
            <div className="w-100">
              ...
              <div className="mt-4 pt-5 d-flex align-items-center text-justify" style={{ fontWeight: 500 }}>
                ...
                Withdraw is Currently Disabled because of Security Reasons. Please Come Back Later. It will be Available Soon.

              </div>

              <div>

                <img src={withdrawClose} alt="Withdraw Closed" className="w-100" />
            ...
            <>
              ...
              <div className="mt-4 pt-5">
                ...
                अब आप अपनी पूरी राशि (100%) बिना किसी सीमा के निकाल सकते हैं। अनलिमिटेड विदड्रॉल की सुविधा शुरू हो चुकी है। 🙏
                        ...
                        {(Boolean(isMypayzonePayoutBankActive) || Boolean(isMypayzone2PayoutBankActive)) && (
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="justify-content-center">
                                <div>
                                  {isMypayzone2PayoutBankActive == true &&
                                    mypayzoneSelectedType === "UPI" ?
                                    <strong className="bank_title">UPI Transfer</strong>
                                    :
                                    <strong className="bank_title">Bank Transfer</strong>
                                  }
                                  <br />
                                  <small className="bank_title_caption">
                                    Minimum withdrawal amount ₹95
                      ...
                      <div>
                        ...
                        */}
                            ...
                            <div className="account_details">
                              ...
                              {(Boolean(isMypayzonePayoutBankActive) || Boolean(isMypayzone2PayoutBankActive)) && mypayzoneSelectedType && mypayzoneSelectedType == "IMPS" && type == "mypayzone" && (
                                <div>
                                  <div>
                                    <label
                                      htmlFor="username "
                              ...
                              {mypayzoneSelectedType && mypayzoneSelectedType == "UPI" && type == "mypayzone" && (
                                <div>
                                  <div>
                                    <label
                                      htmlFor="username"
                                    ...
                                    <div className="field col-12 p-0 mt-1 mb-3" style={{ textAlign: "center" }}>
                                      <input
                                        type="text"
                                        className="bank_account_form"
                                        id="account_no"
                                  ...
                                  <div className="col-12 p-0" style={{ textAlign: "center" }}>
                                    <input
                                      type="text"
                                      className="bank_account_form"
                                      id="account_no"
                                  ...
                                  <small className="text-danger" style={{ textAlign: "center" }}>
